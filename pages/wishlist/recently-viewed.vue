<template>
  ...
  <v-card-title class="d-flex pa-0">
    <v-item-group selected-class="text-primary font-weight-bold" class="d-flex ga-2" v-model="selectedDate">
...
watch(datePicker, (newValue) => {
  ...
  // Here you can add logic to filter products based on the selected date
  // For example, you might want to fetch products viewed on that date
});
</script>